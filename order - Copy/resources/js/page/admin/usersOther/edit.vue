                ...
                <div class="card-body">
                    <form @submit.prevent="updateUsers()">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" v-model="users.username" id="username"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" v-model="users.id" id="id"
                                    placeholder="Nhâp mã nhân viên" />
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="email">Email</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" v-model="users.email" id="email"
                                    placeholder="Nhập email khách hàng ( ví dụ: abc@gmail.com )" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" v-model="users.phone" id="phone"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" id="exampleFormControlSelect1"
                                    ...
                                    <option v-for="users_group in users_group" :value="users_group.value"
                                        :key="users_group.value">{{ users_group.group_name }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10">
                                <router-link :to="{ name: 'admin-users-other' }" class="btn btn-primary me-sm-2">
                                    Hủy
                                </router-link>
...
export default defineComponent({
    setup() {
        ...
        const updateUsers = () => {
            axios.put(`http://127.0.0.1:8000/api/users/${route.params.id}`, users.value)
                .then((response) => {
