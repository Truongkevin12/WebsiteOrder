                ...
                <form @submit.prevent="createCustomers()">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <small class="text-danger text-start-center" v-if="errors.customer_image">{{ errors.customer_image[0] }}</small>
                        </div>
                    </div>
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            <router-link :to="{ name:'admin-customer' }" class="btn btn-primary me-sm-2">
                                Hủy
                            </router-link>
...
export default defineComponent({
    setup() {
        ...
        const createCustomers = () => {
            ...
            body.append("customer_ship_addr", customer.value.customer_ship_addr);
            ...
            axios
                ...
                .catch(function (error) {
                    console.log("Error while creating customers:", error);
                });
        };
