                ...
                <div class="card-body">
                    <form @submit.prevent="createCategory">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" v-model="category.prd_group_name"
                                    id="prd_group_name" placeholder="Nhập thêm danh mục vào..." />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select v-model="category.level" class="form-select" id="exampleFormControlSelect1"
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-10">
                                <router-link :to="{ name: 'admin-category' }" class="btn btn-primary me-sm-2">
                                    Hủy
                                </router-link>
